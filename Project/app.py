...
# # -------------------- WELCOME PAGE -----------------------
# elif st.session_state.logged_in and not st.session_state.welcome_complete:
...
# ------------------ WELCOME PAGE ------------------
def welcome_page():
    st.title("👋 Welcome to Maintenance Dashboard")

    st.subheader("🔧 Maintenance Status Categories")
    selected = st.radio("Select a category:", [
        "Vibration Monitoring Status",
        "Coming Soon: Temperature Monitoring",
        "Coming Soon: Oil Analysis"
    ])

    if selected == "Vibration Monitoring Status":
        st.session_state.page = "vibration_monitoring"

# ------------------ VIBRATION PAGE ------------------
def vibration_monitoring_page():
    st.title("🔍 Vibration Monitoring Status")
    try:
        st.image("vibration_status_image.jpg", caption="Vibration Monitoring Dashboard", use_container_width=True)
...
def main():
    if st.session_state.page == "login":
        ...
        if st.session_state.page == "welcome":
            welcome_page()
        elif st.session_state.page == "vibration_monitoring":
            vibration_monitoring_page()
    else:
